...
@Component({
        ...
        @if (loading$ | async) {
          ...
          <div class="grid">
              ...
              <div class="card">
                <div class="card-img">
                  ...
                  <div class="card-overlay">
                    <span class="card-tag">Génie Civil</span>
                  </div>
                </div>
                <div class="card-body">
                  <h3>{{ projet.titre }}</h3>
            ...
            @empty {
              <div class="empty">
                ...
                <button (click)="clearSearch()">Effacer la recherche</button>
              </div>
            }
          </div>
          ...
          @if ((page$ | async)?.totalPages! > 1) {
            <div class="pagination">
              ...
              <button class="page-btn"
                [disabled]="currentPage === (page$ | async)?.totalPages! - 1"
  ...
  styles: [`
    ...
    .empty button { margin-top: 1rem; padding: 0.6rem 1.25rem; background: #0d47a1; color: white; border: none; border-radius: 8px; cursor: pointer; }
    ...
    .page-btn:hover:not(:disabled) { border-color: #0d47a1; color: #0d47a1; }
...
export class ProjetsComponent implements OnInit, OnDestroy {
  projets$ = this.store.select(selectProjets);
  page$ = this.store.select(selectProjetPage);
  loading$ = this.store.select(selectProjetsLoading);
  ...
  ngOnInit() {
    // RxJS debounceTime pour la recherche
